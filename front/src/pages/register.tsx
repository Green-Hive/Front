...
const SignUp: React.FC = () => {
  ...
  const onSubmit = handleSubmit(({ email, password, confirmPassword, remember }) => {
        ...
        <div className="max-w-md w-full mx-auto mt-4 bg-white p-12 border border-gray-300">
          ...
          <form className="space-y-4" onSubmit={onSubmit}>
            <div className="text-left">
              ...
              />
              {errors.email && <span className="text-red-500">Email is invalid</span>}
            </div>
            <div >
            ...
            <div>
              <label className="text-sm font-bold text-left block">Confirm Password</label>
              <div className='relative flex items-center'>
              <input
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="" className="ml-2 text-grey-600">Remember me</label>
              </div>
            </div>
            <div className="mt-4">
